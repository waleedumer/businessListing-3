...
{{--                                <i class=" <?php echo is_wishlisted($listing['id']) ? 'fas fa-heart' : 'far fa-heart'; ?> "></i>--}}
                        ...
                        <div class="wrapper <?php if($listing['is_featured'] == 1) echo 'featured-body'; ?>">
                            ...
                            <small>
                                <?php
                                $is_city 	 = $listing->city()->exists();
                                $city=$listing->city;
                                $country = $listing->country;
                                echo $is_city?$city['name']:'unavailable'.', '.$country['name'];
                                ?>
                            </small>
                            <p class="ellipsis">
                        ...
                        <ul class="<?php if($listing['is_featured'] == 1) echo 'featured-footer'; ?> mb-0">
                            ...
                            <li>
                                <div class="score">
                                    ...
                                    <strong><?php
                                        if(!empty($listing->reviews->first()->review_rating)){
                                        echo $listing->reviews->first()->review_rating;
                                        }
                                        ?>
                                    S</strong></div>
                            </li>
