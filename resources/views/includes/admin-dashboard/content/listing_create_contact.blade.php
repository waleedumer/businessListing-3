...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control" name="facebook" id="facebook" placeholder="www.facebook.com/xyz/">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control" name="twitter" id="twitter" placeholder="www.twitter.com/xyz/">
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label" for="linkedin">Linkedin</label>
    <div class="col-sm-7">
        <input type="text" class="form-control" name="linkedin" id="linkedin" placeholder="www.linkedin.com/xyz/">
    </div>
</div>
