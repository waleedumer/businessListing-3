            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-offset-3 col-lg-6">
                        <form class="form-inline" action="<?php echo url('admin/report/filter_by_date_range') ?>" method="get">
                            <div class="col-lg-10">
                    ...
                    <div class="col-lg-12">
                        <table class="table table-bordered datatable">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="<?php echo url('admin/package_invoice/'.$purchase_history['id']); ?>" class="btn btn-info"><i class="mdi mdi-printer"></i> Invoice</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
