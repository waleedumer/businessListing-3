                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="first">
                                @include ('includes.admin-dashboard.content.listing_create_basic')
                            </div>
                            <div class="tab-pane" id="second">
                                @include ('includes.admin-dashboard.content.listing_create_location')
                            </div>
                            <div class="tab-pane" id="third">
                                @include ('includes.admin-dashboard.content.listing_create_amenity')
                            </div>

                            <div class="tab-pane" id="fourth">
                                @include ('includes.admin-dashboard.content.listing_create_media')
                            </div>

                            <div class="tab-pane" id="fifth">
                                @include ('includes.admin-dashboard.content.listing_create_seo')
                            </div>
                            <div class="tab-pane" id="sixth">
                                @include ('includes.admin-dashboard.content.listing_create_schedule')
                            </div>

                            <div class="tab-pane" id="seventh">
                                @include ('includes.admin-dashboard.content.listing_create_type')
                            </div>

                            <div class="tab-pane" id="eighth">
                                @include ('includes.admin-dashboard.content.listing_create_contact')
                            </div>
                            <div class="tab-pane" id="ninth">
                                @include ('includes.admin-dashboard.content.listing_create_finish')
                            </div>
                        </div>
                    </div>
