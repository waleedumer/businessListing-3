<?php $products = $product_details->product_details; ?>
<div id = "special_offer_parent_div" style="display: none; padding-top: 10px;">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        <div class="panel-body">
                            <h5 class="card-title mb-0">Special offers
                                <?php if ($key > 0 ): ?>
                                <button type="button" class="btn btn-danger btn-sm btn-rounded alignToTitleOnPreview" name="button" id = "<?php echo $product['id']; ?>" onclick="removeSpecialOffer(this)">Remove this product</button>
                                <?php endif; ?>
                            </h5>
    ...
    <div class="row text-center">
        <button type="button" class="btn btn-primary" name="button" onclick="appendSpecialOffer()"> <i class="mdi mdi-plus"></i> Add new product</button>
    </div>
</div>
