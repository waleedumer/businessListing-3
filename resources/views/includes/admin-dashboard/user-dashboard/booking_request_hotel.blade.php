                ...
                <table class="table table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            echo '<br>'.'Requesting_date'.' : '.date('d M Y', $booking['created_at']);
                            ?>
                        </td>
                        <td>
                        ...
                        <td style="text-align: center;">
                            ...
                            <a href="<?php echo url('user/booking_request_hotel/approved/'.$booking['id']); ?>" class="btn btn-default btn-sm btn-icon icon-left">
                                <i class="entypo-check"></i>
                                Approve
                            </a>
                            <?php }else{ ?>
                            <a href="<?php echo url('user/booking_request_hotel/pending/'.$booking['id']); ?>" class="btn btn-default btn-sm btn-icon icon-left">
                                <i class="entypo-check"></i>
                                Pending>
                            </a>
                            <?php } ?>
                            <?php } ?>
                            <a href="#" class="btn btn-danger btn-sm btn-icon icon-left" onclick="confirm_modal('<?php echo url('user/booking_request_hotel/delete/'.$booking['id']); ?>');">
