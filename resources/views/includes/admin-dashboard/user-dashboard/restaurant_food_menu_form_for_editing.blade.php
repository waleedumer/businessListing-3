                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        <div class="panel-body">
                            <h5 class="card-title mb-0">Food menu
                                <?php if ($key > 0 ): ?>
                                <button type="button" class="btn btn-danger btn-sm btn-rounded alignToTitleOnPreview" name="button" id = "<?php echo $food_menu['id']; ?>" onclick="removeFoodMenu(this)">Remove this food menu; ?></button>
                                <?php endif; ?>
                            </h5>
                                        ...
                                        <div class="wrapper-image-preview">
                                            <div class="box">
                                                ...
                                                <div class="upload-options">
                                                    <label for="menu-image-<?php echo $food_menu['id']; ?>" class="btn"> <i class="entypo-camera"></i> Upload menu image <small>(200 X 200) </small>  </label>
