                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        <div class="panel-body">
                            <h5 class="card-title mb-0">Beauty service
                                <?php if ($key > 0 ): ?>
                                <button type="button" class="btn btn-danger btn-sm btn-rounded alignToTitleOnPreview" name="button" id = "<?php echo $beauty_service['id']; ?>" onclick="removeBeautyService(this)">Remove this beauty service</button>
                                <?php endif; ?>
                            </h5>
                            <div class="collapse show" style="padding-top: 10px;">
                                <div class="row no-margin">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <label for="service_price">Service price{{App\Setting::all()->keyBy('type')['system_currency']->description}}('.currency_code_and_symbol().')'; ?></label>
                                        ...
                                        <div class="wrapper-image-preview">
                                            <div class="box">
                                                ...
                                                <div class="upload-options">
                                                    <label for="service-image-<?php echo $beauty_service['id']; ?>" class="btn"> <i class="entypo-camera"></i> Upload Service image <small>(200 X 200) </small>  </label>
