            ...
            <div class="panel-body">
                <form class="" action="<?php echo site_url('admin/map_settings/map_update'); ?>" method="post">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group" style="padding-bottom: 50px;">
                          <label for="default_location" class="col-sm-3 control-label"><?php echo get_phrase('default_location'); ?> (<?php echo get_phrase('latitude'); ?>, <?php echo get_phrase('longitude'); ?>)</label>
                          <div class="col-md-7">
